// Combined file generated by uRequire v0.6.0, with help from r.js & almond
(function (global){
  ...
  var factory = function(chai, _, _B) {
/**
...
define('blending/Blender-spec',['require','exports','module'],
  ...
  describe("Blender & DeepCloneBlender:", function () {
    ...
    describe("Options passing:", function () {
      ...
      return describe("Options go up the inheritance:", function () {
        var SomeBlender, SomeOtherBlender, _ref, _ref1;
        SomeBlender = function (_super) {
          __extends(SomeBlender, _super);
          function SomeBlender() {
            _ref = SomeBlender.__super__.constructor.apply(this, arguments);
            return _ref;
          }
        ...
        SomeOtherBlender = function (_super) {
          ...
          function SomeOtherBlender() {
            _ref1 = SomeOtherBlender.__super__.constructor.apply(this, arguments);
            return _ref1;
          }
    ...
    return describe("Blender behaviors:", function () {
      ...
      return describe("Advanced examples:", function () {
        ...
        return describe("Chained BlenderBehaviors & Subclassed Blenders (are the same stuff): ", function () {
          var FunctionOverWriterBlender, UselessBlender, WeirdBlender, addingNumbersAndConcatEmToStringBlender, bi, blender, funcOverwrite, weirdBB, weirdBlender, _i, _len, _ref, _ref1, _ref2, _ref3, _results;
          ...
          FunctionOverWriterBlender = function (_super) {
            ...
            function FunctionOverWriterBlender() {
              _ref = FunctionOverWriterBlender.__super__.constructor.apply(this, arguments);
              return _ref;
            }
          ...
          UselessBlender = function (_super) {
            ...
            function UselessBlender() {
              _ref1 = UselessBlender.__super__.constructor.apply(this, arguments);
              return _ref1;
            }
          ...
          WeirdBlender = function (_super) {
            ...
            function WeirdBlender() {
              _ref2 = WeirdBlender.__super__.constructor.apply(this, arguments);
              return _ref2;
            }
          ...
          _results = [];
          for (bi = _i = 0, _len = _ref3.length; _i < _len; bi = ++_i) {
            blender = _ref3[bi];
...
define('blending/shared/deepExtendExamples-specs',['require','exports','module'],
  function (require, exports, module) {
...
define('blending/shared/lodashMerge-specs',['require','exports','module'],
  function (require, exports, module) {
...
define('blending/deepExtend-spec',['require', 'exports', 'module', './shared/deepExtendExamples-specs', './shared/lodashMerge-specs'], 
  function (require, exports, module) {
...
define('blending/shared/lodashMerge_Blender-specs',['require','exports','module'],
  function (require, exports, module) {
...
define('blending/lodash-merge-spec',['require', 'exports', 'module', './shared/lodashMerge-specs', './shared/lodashMerge_Blender-specs'], 
  function (require, exports, module) {
...
define('blending/Mergers_Blender-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('blending/DeepDefaultsBlender-spec',['require','exports','module'],
  function (require, exports, module) {
  
// uRequire v0.6.0: START body of original nodejs module
  var Class3, assert, bundle, bundle_project_team, c3, earth, earth_laboratory_experiment, expect, expectedPropertyValues, experiment, experiment_laboratory_earth, l, laboratory, laboratory_experiment, objectWithProtoInheritedProps, project, team;
  assert = chai.assert;
  expect = chai.expect;
...
define('blending/ArrayizePushBlender-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('blending/traverse-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/getInheritedPropertyNames-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/getp-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/getRefs-spec',['require','exports','module'],
  function (require, exports, module) {
...
// uRequire v0.6.0: START body of original nodejs module
  ...
  describe("getRefs:", function () {
    it("from array, deep = false", function () {
      ...
      refs = _B.getRefs(oa);
      return expect(_B.isEqualArraySet(refs, [
        oa[3],
        oa[2]
      ])).to.be["true"];
    });
...
define('objects/isDisjoint-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/isEqual-spec',['require','exports','module'],
  function (require, exports, module) {
  
// uRequire v0.6.0: START body of original nodejs module
  var Class3, assert, c3, c3Clone, expect, expectedPropertyValues, inheritedDeepClone, inheritedShallowClone, l, oClone, object, objectDeepClone1, objectDeepClone2, objectShallowClone1, objectShallowClone2, objectWithProtoInheritedProps;
  assert = chai.assert;
  expect = chai.expect;
  ...
  describe("isEqual:", function () {
      ...
      if (_B.isLodash()) {
        return describe("callback (lodash only):", function () {
          ...
          return it("should treat all falsey (except undefined) as false ", function () {
            var falsey, _i, _len, _ref, _results;
            _ref = [
              "",
              0,
              NaN,
    ...
    describe("options.onlyProps - ignores value & type of property containers (primitives as Object, functions etc):", function () {
      ...
      describe("only properties matter, even on NON-equal types:", function () {
        ...
        return it("works on property containers hashes, instances, Arguments, Functions & Arrays etc:", function () {
          ...
          return expect(_B.isEqual(instance, func, { onlyProps: true })).to.be["true"];
        });
      });
...
define('objects/isRefDisjoint-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/mutate-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/okv-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/setp-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('collections/go-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('collections/array/arrayize-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('collections/array/isEqualArraySet-spec',['require','exports','module'],
  function (require, exports, module) {
...
define('uberscore',[],function () {
  if (typeof _B !== 'undefined'){return _B;};if (typeof _uB !== 'undefined'){return _uB;}
return __nodeRequire('uberscore');
});
define('spec-data',['require', 'exports', 'module', 'lodash'], 
  function (require, exports, module) {
...
define('agreement/isAgree-spec',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore', '../spec-data'], 
  function (require, exports, module) {
...
define('types/types-spec',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore'], 
  function (require, exports, module) {
...
define('utils/CoffeeUtils-spec',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore'], 
  function (require, exports, module) {
...
define('utils/CalcCachedProperties-spec',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore'], 
  function (require, exports, module) {
  
// uRequire v0.6.0: START body of original nodejs module
  var assert, chai, expect, l, _, _B, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
      for (var key in parent) {
        if (__hasProp.call(parent, key))
          child[key] = parent[key];
      }
  ...
  describe("_B.CalcCachedProperties:", function () {
    var CalcCachedProperties2, DirtyNumbers, SelfishNumber, _ref, _ref1;
    CalcCachedProperties2 = function (_super) {
      __extends(CalcCachedProperties2, _super);
      function CalcCachedProperties2() {
        _ref = CalcCachedProperties2.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    DirtyNumbers = function (_super) {
      ...
      function DirtyNumbers() {
        _ref1 = DirtyNumbers.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
...
define('Logger-spec',['require', 'exports', 'module', 'chai'], 
  function (require, exports, module) {
...
define('uberscore-spec',['require', 'exports', 'module', 'uberscore'], 
  function (require, exports, module) {
...
define('index',['require', 'exports', 'module', './blending/Blender-spec', './blending/deepExtend-spec', './blending/lodash-merge-spec', './blending/Mergers_Blender-spec', './blending/DeepDefaultsBlender-spec', './blending/ArrayizePushBlender-spec', './blending/traverse-spec', './objects/getInheritedPropertyNames-spec', './objects/getp-spec', './objects/getRefs-spec', './objects/isDisjoint-spec', './objects/isEqual-spec', './objects/isRefDisjoint-spec', './objects/mutate-spec', './objects/okv-spec', './objects/setp-spec', './collections/go-spec', './collections/array/arrayize-spec', './collections/array/isEqualArraySet-spec', './agreement/isAgree-spec', './types/types-spec', './utils/CoffeeUtils-spec', './utils/CalcCachedProperties-spec', './Logger-spec', './spec-data', './uberscore-spec'], 
  function (require, exports, module) {
...
return module.exports;
    ...
    var data; data = require('spec-data');
  ...
  if (__isAMD) {
    define(['chai', 'lodash', 'uberscore'], factory);
      ...
      if (__isNode) {
          module.exports = factory(require('chai'), require('lodash'), require('uberscore'));
