// Combined file generated by uRequire v{NO_VERSION}, with help from r.js & almond
(function (){
...
describe("Blender:", function() {
    describe("Internals: blender.adjustBlenderBehavior:", function() {
        return describe("corectly transforms nested types of srcDstSpecs to short format", function() {
            it("works with simple 'src' and 'dst'", function() {
                ...
                return expect(_.isEqual(blender.blenderBehaviors[0], expectedAdjustedBb));
            });
            return it("works with bbOrder specs ['src', 'path', 'dst']", function() {
                ...
                return expect(_.isEqual((new _B.DeepCloneBlender(longTypePathBb)).blenderBehaviors[0], expectedAdjustededBb));
            });
        });
    });
    describe("Handles primitives:", function() {
        ...
        it("overwrites undefined / null:", function() {
            expect(blender.blend(void 0, 6, 18) === 18);
            expect(blender.blend(void 0, "a string") === "a string");
            expect(blender.blend(null, 16.7) === 16.7);
            expect(blender.blend(null, "a string") === "a string");
            return expect(_.isEqual(blender.blend(void 0, 18, {
                prop: "someValue"
            }), {
                prop: "someValue"
            }));
        ...
        return it("overwrites primitives", function() {
            expect(blender.blend(6, 18) === 18);
            expect(blender.blend("a string", 18, "another string") === "another string");
            return expect(_.isEqual(blender.blend("a string", 18, {
                prop: "someValue"
            }), {
                prop: "someValue"
            }));
    ...
    describe("Options passing:", function() {
        ...
        it("deepCloneBlender.anOption is someOptions.anOption", function() {
            ...
            return expect(deepCloneBlender.anOption === someOptions.anOption);
        });
        it("real options: ", function() {
            var deepCloneBlender;
            deepCloneBlender = new _B.DeepCloneBlender;
            expect(deepCloneBlender.inherited === false);
            expect(deepCloneBlender.copyProto === false);
            deepCloneBlender = new _B.DeepCloneBlender([], {
                inherited: inherited,
                copyProto: copyProto
            });
            expect(deepCloneBlender.inherited === inherited);
            return expect(deepCloneBlender.copyProto === copyProto);
        });
        return describe("Options go up the inheritance:", function() {
            ...
            it("respecting subclassed options #1", function() {
                ...
                expect(someBlender.someOption === "someOptionValue");
                someBlender = new SomeBlender([], {
                    someOption: "someRedefinedOptionValue"
                });
                return expect(someBlender.someOption === "someRedefinedOptionValue");
            });
            return it("respecting subclassed options #2", function() {
                var someOtherBlender;
                someOtherBlender = new SomeOtherBlender;
                expect(someOtherBlender.someOption === "someOptionValue of SomeOtherBlender");
                someOtherBlender = new SomeOtherBlender([], {
                    someOption: "someRedefinedOptionValue"
                });
                expect(someOtherBlender.someOption === "someRedefinedOptionValue");
                return expect(someOtherBlender.someOtherOption === "someOtherOptionValue");
            });
        });
    });
    return describe("Blender behaviors:", function() {
        describe("Simple examples:", function() {
            ...
            it("Numbers dont just overwrite each other: the source is doubled and then added up to destination", function() {
                var deepCloneBlenderAddingNumbers, result;
            ...
            return it("Lets filter objects: Strings are banned", function() {
        ...
        return describe("Advanced examples:", function() {
            ...
            return describe("Chained BlenderBehaviors & Subclassed Blenders (are the same stuff): ", function() {
                var FunctionOverWriterBlender, UselessBlender, WeirdBlender, addingNumbersAndConcatEmToStringBlender, bi, blender, funcOverwrite, weirdBB, weirdBlender, _i, _len, _ref, _results;
                ...
                _ref = [ addingNumbersAndConcatEmToStringBlender, weirdBlender ];
                _results = [];
                for (bi = _i = 0, _len = _ref.length; _i < _len; bi = ++_i) {
                    blender = _ref[bi];
...
(function (window) {
  define('index',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore', './spec-data', './blending/Blender-spec', './blending/deepCloneDefaults-spec', './blending/deepExtend-spec', './blending/lodash-merge-spec', './blending/Mergers_Blender-spec', './blending/DeepDefaultsBlender-spec', './objects/getInheritedPropertyNames-spec', './objects/getRefs-spec', './objects/getValueAtPath-spec', './objects/isDisjoint-spec', './objects/isEqual-spec', './objects/isRefDisjoint-spec', './objects/mutate-spec', './objects/okv-spec', './objects/setValueAtPath-spec', './collections/go-spec', './collections/array/arrayize-spec', './collections/array/isEqualArraySet-spec', './type-spec', './isPlain-spec', './uberscore-spec'], 
  function (require, exports, module, chai, _, _B, data) {
  // uRequire: start body of original nodejs module
