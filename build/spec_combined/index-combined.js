    ...
    for (typeName in oOs) {
        ...
        _results.push(function(typeName, value, longType, shortType) {
            return it("recognises type '" + typeName + "', both as long='" + longType + "' & short='" + shortType + "'", function() {
                ...
                return expect(_B.type.areEqual(longType, shortType)).to.equal(true);
            });
...
(function (window) {
  define('index',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore', './spec-data', './arrayize-spec', './blending/deepExtend-spec', './blending/Blender-spec', './blending/lodash-merge-spec', './deepCloneDefaults-spec', './go-spec', './okv-spec', './mutate-spec', './type-spec', './isPlain-spec', './uberscore-spec'], 
  function (require, exports, module, chai, _, _B, data) {
  // uRequire: start body of original nodejs module
