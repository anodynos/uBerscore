// Combined file generated by uRequire v0.4.0alpha21, with help from r.js & almond
(function (){
...
(function (window) {
  define('index',['require', 'exports', 'module', 'chai', 'lodash', 'uberscore', './spec-data', './blending/Blender-spec', './blending/deepExtend-spec', './blending/lodash-merge-spec', './blending/Mergers_Blender-spec', './blending/DeepDefaultsBlender-spec', './objects/getInheritedPropertyNames-spec', './objects/getRefs-spec', './objects/getp-spec', './objects/isDisjoint-spec', './objects/isEqual-spec', './objects/isRefDisjoint-spec', './objects/mutate-spec', './objects/okv-spec', './objects/setp-spec', './collections/go-spec', './collections/array/arrayize-spec', './collections/array/isEqualArraySet-spec', './type-spec', './isPlain-spec', './uberscore-spec'], 
  function (require, exports, module, chai, _, _B, data) {
  // uRequire: start body of original nodejs module
