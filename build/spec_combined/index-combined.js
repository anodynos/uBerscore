...
* Version 0.0.18 - Compiled on 2014-11-11 20:11:08
* Repository git://github.com/anodynos/uBerscore
* Copyright(c) 2014 Agelos Pikoulas <agelos.pikoulas@gmail.com>
* License MIT http://www.opensource.org/licenses/mit-license.php
*/

// Generated by uRequire v0.7.0-beta8 - template: 'combined' 
...
var bundleFactory = function(_, _lodash_, _lodash_dummy_var, _B, _uB, uberscore, chai) {
/**
...
define('lodash',[],function () {
  ...
  return __nodeRequire('lodash');
    ...
    return (typeof _ !== 'undefined') ? _ :  (typeof _lodash_ !== 'undefined') ? _lodash_ :  (typeof _lodash_dummy_var !== 'undefined') ? _lodash_dummy_var : __throwMissing('lodash', '_, _lodash_, _lodash_dummy_var')
}
});
define('uberscore',[],function () {
  ...
  return __nodeRequire('uberscore');
    ...
    return (typeof _B !== 'undefined') ? _B :  (typeof _uB !== 'undefined') ? _uB :  (typeof uberscore !== 'undefined') ? uberscore : __throwMissing('uberscore', '_B, _uB, uberscore')
}
});
...
define('blending/deepExtend-spec',['require', 'exports', 'module', 'lodash', './shared/deepExtendExamples-specs', './shared/lodashMerge-specs'], function (require, exports, module) {
      ...
      return describe("Arrays with reference values:", function () {
        ...
        it("leaves dst items untouched", function () {
          ...
          for (i = _i = 0; _i <= 2; i = ++_i) {
            _results.push(equal(result[i], dstArray[i]));
          }
          return _results;
        });
        return it("leaves source items untouched, pushed as exact refs to destination", function () {
          ...
          _results = [];
          for (i = _i = 0; _i <= 2; i = ++_i) {
            _results.push(equal(result[i + 3], srcArray[i]));
          }
          return _results;
        });
      });
...
define('collections/go-spec',['require','exports','module'],function (require, exports, module) {
...
var arrInt, arrInt2, arrStr, obj, _ref;
...
if (__isAMD) {
  return define(['lodash', 'lodash', 'lodash', 'uberscore', 'uberscore', 'uberscore', 'chai'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('lodash'), require('lodash'), require('lodash'), require('uberscore'), require('uberscore'), require('uberscore'), require('chai'));
    } else {
        return bundleFactory((typeof _ !== 'undefined') ? _ :  (typeof _lodash_ !== 'undefined') ? _lodash_ :  (typeof _lodash_dummy_var !== 'undefined') ? _lodash_dummy_var : void 0, (typeof _ !== 'undefined') ? _ :  (typeof _lodash_ !== 'undefined') ? _lodash_ :  (typeof _lodash_dummy_var !== 'undefined') ? _lodash_dummy_var : void 0, (typeof _ !== 'undefined') ? _ :  (typeof _lodash_ !== 'undefined') ? _lodash_ :  (typeof _lodash_dummy_var !== 'undefined') ? _lodash_dummy_var : void 0, (typeof _B !== 'undefined') ? _B :  (typeof _uB !== 'undefined') ? _uB :  (typeof uberscore !== 'undefined') ? uberscore : void 0, (typeof _B !== 'undefined') ? _B :  (typeof _uB !== 'undefined') ? _uB :  (typeof uberscore !== 'undefined') ? uberscore : void 0, (typeof _B !== 'undefined') ? _B :  (typeof _uB !== 'undefined') ? _uB :  (typeof uberscore !== 'undefined') ? uberscore : void 0, (typeof chai !== 'undefined') ? chai : void 0);
    }
}
