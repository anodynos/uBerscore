...
var bundleFactory = function(chai, _, _B) {/**
...
define('uberscore',[],function () {
  ...
  return (typeof _B !== 'undefined') ? _B : __nodeRequire('uberscore')
}
});
...
define('blending/ArrayizePushBlender-spec',['require','exports','module'],function (require, exports, module) {
...
define('index',['require', 'exports', 'module', 'lodash', 'uberscore', './blending/Blender-spec', './blending/deepExtend-spec', './blending/lodash-merge-spec', './blending/Mergers_Blender-spec', './blending/DeepDefaultsBlender-spec', './blending/ArrayizePushBlender-spec', './blending/traverse-spec', './blending/clone-spec', './objects/getInheritedPropertyNames-spec', './objects/getp-spec', './objects/getRefs-spec', './objects/isDisjoint-spec', './objects/isEqual-spec', './objects/isRefDisjoint-spec', './objects/mutate-spec', './objects/okv-spec', './objects/setp-spec', './objects/isOK-True-False-spec', './collections/go-spec', './collections/array/arrayize-spec', './collections/array/isEqualArraySet-spec', './agreement/isAgree-spec', './types/types-spec', './utils/CoffeeUtils-spec', './utils/CalcCachedProperties-spec', './Logger-spec', './spec-data', './uberscore-spec'], function (require, exports, module) {
...
return module.exports;
    ...
    var specHelpers = require('specHelpers');
    var data = require('spec-data');

  var equal = specHelpers["equal"], notEqual = specHelpers["notEqual"], ok = specHelpers["ok"], notOk = specHelpers["notOk"], tru = specHelpers["tru"], fals = specHelpers["fals"], deepEqual = specHelpers["deepEqual"], notDeepEqual = specHelpers["notDeepEqual"], exact = specHelpers["exact"], notExact = specHelpers["notExact"], iqual = specHelpers["iqual"], notIqual = specHelpers["notIqual"], ixact = specHelpers["ixact"], notIxact = specHelpers["notIxact"], like = specHelpers["like"], notLike = specHelpers["notLike"], likeBA = specHelpers["likeBA"], notLikeBA = specHelpers["notLikeBA"], equalSet = specHelpers["equalSet"], notEqualSet = specHelpers["notEqualSet"], expect = chai["expect"];
    return require('index');
  };
if (__isAMD) {
  return define(['chai', 'lodash', 'uberscore'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('chai'), require('lodash'), require('uberscore'));
    } else {
        return bundleFactory((typeof chai !== 'undefined') ? chai : void 0, (typeof _ !== 'undefined') ? _ : void 0, (typeof _B !== 'undefined') ? _B : void 0);
    }
}
