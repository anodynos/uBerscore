// Combined file generated by uRequire v0.3.0alpha17, with help from r.js & almond
(function (){
...
(function (window) {
  define('deepExtend-spec',['require', 'exports', 'module', 'chai', 'uberscore'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
...
(function (window) {
  define('index',['require', 'exports', 'module', './arrayize-spec', './deepCloneDefaults-spec', './deepExtend-spec', './go-spec', './okv-spec', './mutate-spec', './spec-data', './uberscore-spec'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
