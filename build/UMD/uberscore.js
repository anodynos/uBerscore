...
* Version 0.0.19 - Compiled on 2016-05-25 01:09:27
...
} else if (typeof define === 'function' && define.amd) { define(['require', 'exports', 'module', 'lodash', './blending/blenders/index', './blending/Blender', './blending/traverse', './blending/clone', './objects/okv', './objects/mutate', './objects/setp', './objects/getp', './objects/isDisjoint', './objects/isRefDisjoint', './objects/getRefs', './objects/getInheritedPropertyNames', './objects/isEqual', './objects/isIqual', './objects/isExact', './objects/isIxact', './objects/isLike', './types/isTrue', './types/isFalse', './collections/array/isEqualArraySet', './collections/array/arrayize', './agreement/isAgree', './agreement/inAgreements', './types/type', './types/isPlain', './types/isHash', './Logger', './certain', './utils/CoffeeUtils', './utils/CalcCachedProperties', './utils/subclass'], factory); } else throw new Error('uRequire: Loading UMD module as <script>, without `build.noLoaderUMD`');
}).call(this, function (require, exports, module, _) {
  

var VERSION = '0.0.19'; // injected by urequire-rc-inject-version
