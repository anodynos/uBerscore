...
(function (root,factory) {
  if (typeof exports === 'object') {
   var nr = new (require('urequire').NodeRequirer) ('utils/CalcCachedProperties', module, __dirname, '.');
   module.exports = factory(nr.require, nr.require('./CoffeeUtils'), nr.require('lodash'), nr.require('../agreement/isAgree'));
 } else if (typeof define === 'function' && define.amd) {
     define(['require', './CoffeeUtils', 'lodash', '../agreement/isAgree', '../Logger'], factory);
 }
}).call(this, this,function (require, CoffeeUtils, _, isAgree) {
