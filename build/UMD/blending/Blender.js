...
(function (factory) {
  if (typeof exports === 'object') {
    module.exports = factory(require, require('../types/type'), require('../objects/getp'), require('../types/isHash'), require('../utils/CoffeeUtils'), require('lodash'), require('../agreement/isAgree'));
} else if (typeof define === 'function' && define.amd) { define(['require', '../types/type', '../objects/getp', '../types/isHash', '../utils/CoffeeUtils', 'lodash', '../agreement/isAgree', '../utils/subclass', '../Logger'], factory) } else throw new Error('uRequire: Loading UMD module as <script>, without `build.noLoaderUMD`');
}).call(this, function (require, type, getp, isHash, CoffeeUtils, _, isAgree) {
