...
(function (root,factory) {
  if (typeof exports === 'object') {
   ...
   module.exports = factory(nr.require, nr.require('../types/type'), nr.require('../objects/getp'), nr.require('../types/isHash'), nr.require('../utils/CoffeeUtils'), nr.require('lodash'), nr.require('../agreement/isAgree'));
 } else if (typeof define === 'function' && define.amd) {
     define(['require', '../types/type', '../objects/getp', '../types/isHash', '../utils/CoffeeUtils', 'lodash', '../agreement/isAgree', '../Logger'], factory);
 }
}).call(this, this,function (require, type, getp, isHash, CoffeeUtils, _, isAgree) {
