...
loggerPath = "./../";
define(['require', 'exports', 'module', loggerPath + "Logger", 'underscore', '../agreement/isAgree', '../uberscore', '../types/isHash'], function (require, exports, module, Logger, _, isAgree) {
  

var deepExtend, isHash, isHash2, isHash3, l, shadowed, uberscore, _lodash_;
  _lodash_ = require("underscore");
