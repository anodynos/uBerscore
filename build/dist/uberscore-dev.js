...
*/
// Combined file generated by uRequire v0.5.0beta1, with help from r.js & almond
(function (){
...
(function (window) {
  define('types/type',['require', 'exports', 'module', 'lodash', '../agreement/isAgree'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
...
(function (window) {
  define('blending/Blender',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', '../types/type', '../objects/getp', '../Logger'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
...
(function (window) {
  define('blending/blenders/DeepCloneBlender',['require', 'exports', 'module', 'lodash', '../../agreement/isAgree', '../Blender', '../../types/type'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var Blender, DeepCloneBlender, type, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
...
(function (window) {
  define('blending/blenders/DeepDefaultsBlender',['require', 'exports', 'module', 'lodash', '../../agreement/isAgree', '../Blender', '../../types/type', './DeepCloneBlender'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var Blender, DeepCloneBlender, DeepDefaultsBlender, type, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
(function (window) {
  ...
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var ArrayizePushBlender, DeepCloneBlender, arrayize, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
(function (window) {
  define('types/isPlain',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', './type'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var type, isPlain;
...
(function (window) {
  define('objects/isEqual',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', '../types/type', '../types/isPlain', '../collections/array/isEqualArraySet', '../Logger'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var isEqual, isEqualArraySet, isEqualDefaults, isPlain, l, type, __indexOf = [].indexOf || function(item) {
    for (var i = 0, l = this.length; i < l; i++) {
        if (i in this && this[i] === item) return i;
    }
    return -1;
...
(function (window) {
  define('types/isObject',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', './type'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var isObject, type;
...
(function (window) {
  define('certain',['require', 'exports', 'module', 'lodash', './agreement/isAgree', './types/isObject'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var certain, isObject;
