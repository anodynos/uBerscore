/**
 * uberscore - version 0.0.15-01
 * Compiled on 2013-12-08 4:04:04
...
define('blending/blenders/ArrayizePushBlender',['require', 'exports', 'module', '../../collections/array/arrayize', './DeepCloneBlender'], function (require, exports, module, arrayize) {
...
var deepExtend, isHash, isHash2, l, shadowed, uberscore, _lodash_;
...
define('objects/isTrue',['require'],function (require) {
...
define('objects/isFalse',['require'],function (require) {
...
if (__isAMD) {
  return define(['lodash'], bundleFactory);
} else {
    if (__isNode) {
