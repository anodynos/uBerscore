/*
* uberscore - version 0.0.9alpha2
* Compiled on 2013-05-30 5:30:27
* git://github.com/anodynos/uBerscore
* Copyright(c) 2013 Agelos Pikoulas (agelos.pikoulas@gmail.com )
* Licensed MIT http://www.opensource.org/licenses/mit-license.php
*/
var VERSION = '0.0.9alpha2'; //injected by grunt:concat
// Combined file generated by uRequire v0.4.0alpha4, with help from r.js & almond
(function (){
...
(function (window) {
  define('Logger',['require', 'exports', 'module', 'lodash', './agreement/isAgree', './agreement/inAgreements', './objects/setValueAtPath', './objects/getValueAtPath'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
...
(function (window) {
  define('blending/Blender',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', '../type', '../objects/getValueAtPath', '../Logger'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
    ...
    Blender.prototype.getNextAction = function(blenderBehavior, bbi, bbOrderValues) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (_.isUndefined(bbOrderValues[bbOrder])) {
                ...
                if (bbOrder === "path") {
                    nextBBSrcDstSpec = getValueAtPath(currentBBSrcDstSpec, this.path.slice(1), {
