...
* Compiled on 2013-09-24 12:42:12
...
define('types/type',['require','exports','module'],
...
define('objects/getp',['require','exports','module'],
  function (require, exports, module) {
...
define('types/isHash',['require', 'exports', 'module', './type'], 
  function (require, exports, module) {
...
define('utils/CoffeeUtils',['require'],
  function (require) {
...
define('agreement/isAgree',['require'],
  function (require) {
...
define('collections/array/arrayize',['require', 'exports', 'module', '../../agreement/isAgree'], 
  function (require, exports, module) {
...
define('agreement/inAgreements',['require', 'exports', 'module', '../collections/array/arrayize'], 
  function (require, exports, module) {
...
define('objects/setp',['require','exports','module'],
  function (require, exports, module) {
...
define('Logger',['require', 'exports', 'module', './agreement/inAgreements', './objects/setp', './objects/getp'], 
  function (require, exports, module) {
  ...
  Logger = function () {
    ...
    getALog = function (baseMsg, color, cons) {
      return function () {
        ...
        title = "" + (_.isEmpty(this.debugPath) ? "Logger" + Logger.loggerCount + " " : "[" + this.debugPath.join("/") + "] ") + baseMsg;
        if (title) {
          title = title + ":";
        }
        args.unshift(title);
    ...
    Logger.addDebugPathLevel = function (debugPath, debugLevel) {
      ...
      return setp(Logger, debugPath, debugLevel, { create: true });
    };
    ...
    Logger.prettify = typeof __isNode !== "undefined" && __isNode !== null && __isNode || (typeof __isNode === "undefined" || __isNode === null) ? function (inspect) {
      var nodeVerLE_092;
...
define('blending/Blender',['require', '../types/type', '../objects/getp', '../types/isHash', '../utils/CoffeeUtils', '../Logger'], 
  function (require, type, getp, isHash, CoffeeUtils) {
          ...
          for (_j = 0, _len1 = props.length; _j < _len1; _j++) {
            ...
            for (bbi = _k = 0, _len2 = _ref.length; _k < _len2; bbi = ++_k) {
              ...
              if (!(result instanceof ActionResult)) {
                ...
                if (this.l.deb(20)) {
                  this.l.debug("Value assigning:  @path =", this.path.join("/"), "\n value =", this.l.prettify(result));
                }
                dst[prop] = result;
              } else {
                if (this.l.deb(30)) {
...
define('blending/blenders/DeepCloneBlender',['require', '../../types/type', '../Blender'], 
...
define('blending/blenders/DeepExtendBlender',['require', '../Blender', '../../Logger'], 
  function (require, Blender) {
...
define('blending/blenders/DeepDefaultsBlender',['require', '../../types/type', './DeepCloneBlender'], 
  function (require, type, DeepCloneBlender) {
...
define('blending/blenders/ArrayizePushBlender',['require', 'exports', 'module', '../../collections/array/arrayize', './DeepCloneBlender'], 
  function (require, exports, module, arrayize) {
...
define('blending/traverse',['require', 'exports', 'module', './Blender'], 
  function (require, exports, module) {
...
define('blending/deepExtend',['require', 'exports', 'module', loggerPath + "Logger", '../types/isHash'], 
  function (require, exports, module, Logger) {
...
define('objects/okv',['require','exports','module'],
  function (require, exports, module) {
...
define('collections/go',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/mutate',['require', 'exports', 'module', '../collections/go'], 
  function (require, exports, module) {
...
define('objects/isDisjoint',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/getRefs',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/isRefDisjoint',['require', 'exports', 'module', './getRefs', './isDisjoint'], 
  function (require, exports, module) {
...
define('objects/getInheritedPropertyNames',['require','exports','module'],
  function (require, exports, module) {
...
define('types/isPlain',['require', 'exports', 'module', './type'], 
  function (require, exports, module) {
...
define('collections/array/isEqualArraySet',['require','exports','module'],
  function (require, exports, module) {
...
define('objects/isEqual',['require', 'exports', 'module', '../types/type', '../types/isPlain', '../types/isHash', '../collections/array/isEqualArraySet', '../Logger'], 
  function (require, exports, module) {
...
define('objects/isIqual',['require', 'exports', 'module', './isEqual'], 
  function (require, exports, module) {
...
define('objects/isExact',['require', 'exports', 'module', './isEqual'], 
  function (require, exports, module) {
...
define('objects/isIxact',['require', 'exports', 'module', './isIqual'], 
  function (require, exports, module) {
...
define('objects/isLike',['require', 'exports', 'module', './isEqual'], 
  function (require, exports, module) {
...
define('certain',['require', 'exports', 'module', './types/isHash'], 
  function (require, exports, module) {
...
define('utils/CalcCachedProperties',['require', './CoffeeUtils', '../Logger'], 
  function (require, CoffeeUtils) {
...
return __umodule;
    ...
    var isAgree; isAgree = require('agreement/isAgree');
