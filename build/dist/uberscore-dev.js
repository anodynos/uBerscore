// Combined file generated by uRequire v0.3.0alpha23, with help from r.js & almond
(function (){
...
Logger = function() {
    ...
    Logger.prototype.debug = function() {
        ...
        return function() {
            ...
            if (level <= this.effectiveDebugLevel()) {
                log.apply(this, msgs);
            }
            return this.lastDebugLevelCheck = void 0;
        };
    }();
    Logger.prototype.effectiveDebugLevel = function() {
        if (Logger.debugLevel !== void 0) {
            if (Logger.debugLevel <= 0) {
                return -Infinity;
            } else {
                return _.max([ Logger.debugLevel, this.debugLevel, 0 ]);
            }
        } else {
    ...
    Logger.prototype.deb = function(debugLevel) {
        if (debugLevel <= this.effectiveDebugLevel()) {
...
(function (window) {
  define('blending/Blender',['require', 'exports', 'module', 'lodash', '../agreement/isAgree', '../Logger', '../type', '../objects/getValueAtPath', '../YouAreDaChef'], 
  function (require, exports, module, _, isAgree) {
  // uRequire: start body of original nodejs module
var Blender, YADC, getValueAtPath, l, type, _, __bind = function(fn, me) {
    return function() {
...
Blender = function() {
    ...
    Blender.prototype.getNextAction = function(blenderBehavior, bbi, bbOrderValues) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (l.deb(80)) {
                l.debug("At bbOrder='" + bbOrder + "'", bbOrder === "path" ? " @path=" + l.prettify(this.path) : " bbOrderValues[bbOrder]='" + bbOrderValues[bbOrder] + "'", " currentBBSrcDstSpec =\n", currentBBSrcDstSpec);
            }
            if (_.isUndefined(bbOrderValues[bbOrder])) {
                throw l.err("_.Blender.blend: Error: Invalid BlenderBehavior `order` '" + bbOrder + "',\nwhile reading BlenderBehavior #" + bbi + " :\n", this.blenderBehaviors[bbi], "\n\nDefault BlenderBehavior order is ", this.defaultBBOrder);
            } else {
                if (bbOrder === "path") {
            ...
            for (_j = 0, _len1 = props.length; _j < _len1; _j++) {
                ...
                for (bbi = _k = 0, _len2 = _ref.length; _k < _len2; bbi = ++_k) {
                    ...
                    if (nextBBSrcDstSpec === void 0) {
                        ...
                        if (!_.isFunction(action)) {
                            if (!_.isString(action)) {
                                throw l.err("_B.Blender.blend: Error: Invalid BlenderBehavior `action` (neither 'Function' nor 'String') : ", action);
                            } else {
                    ...
                    if (!(result === Blender.SKIP || result === Blender.NEXT || result === Blender.DELETE || result === Blender.DELETE_NEXT)) {
                        ...
                        if (l.deb(20)) {
                            l.debug("Action Called - Value assigning:  @path =", this.path.join("/"), "\n  value =", l.prettify(result));
                        }
                        dst[prop] = result;
                    } else {
                        if (l.deb(30)) {
                            l.debug("Action Called - ActionResult = ", result);
                        }
