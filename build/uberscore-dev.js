...
* Version 0.0.18 - Compiled on 2014-11-11 20:11:05
...
module.exports = Logger = function () {
  var ANSI_BLACK, ANSI_BLACK_BOLD, ANSI_BLUE, ANSI_BLUE_BOLD, ANSI_CYAN, ANSI_CYAN_BOLD, ANSI_GREEN, ANSI_GREEN_BOLD, ANSI_PURPLE, ANSI_PURPLE_BOLD, ANSI_RED, ANSI_RED_BOLD, ANSI_RESET, ANSI_WHITE, ANSI_WHITE_BOLD, ANSI_YELLOW, ANSI_YELLOW_BOLD, arrayizeDebugPath, countNewLines, getALog, key, val, _ref;
  ...
  return Blender = function (_super) {
    ...
    function Blender() {
      ...
      if (_.isArray(this.blenderBehaviors[0])) {
        if (this.l.deb(20)) {
          this.l.deb("We might have options:", this.blenderBehaviors);
        }
...
define('objects/mutate',['require', 'exports', 'module', '../collections/go', '../agreement/isAgree'], function (require, exports, module) {
